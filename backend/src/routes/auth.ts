...
import { signup, login, logout, getCurrentUser, updateAvatar, deleteAvatar, updateProfile, updatePassword, generate2FA, verify2FA, disable2FA, login2FA, testAuth, testAdmin, testFaculty, deleteAccount } from "../controllers/authController";
