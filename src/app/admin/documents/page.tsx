...
export default function AdminDocuments() {
  ...
  const filteredFiles = allFiles.filter(f => {
    const matchDomain = filterDomain === "All Domains" || f.domain === filterDomain;
    const matchFaculty = filterFaculty === "All Faculty" || f.uploadedBy === filterFaculty;
    return matchDomain && matchFaculty;
  });
  ...
  } = useDataView(filteredFiles, "Newest first", 10);
