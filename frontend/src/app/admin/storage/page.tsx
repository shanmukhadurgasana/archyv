        ...
        <div className="flex flex-col lg:flex-row gap-8 items-center lg:items-start mb-10">
          ...
          <div className="flex-1 grid grid-cols-2 md:grid-cols-5 gap-6 w-full">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="text-xs text-gray-500 font-semibold uppercase tracking-wider">Trash Files</div>
              <div className="text-xl font-bold text-foreground">{trashFiles.length}</div>
            </div>
          </div>
        </div>
